# iter-5 / multi-flusher V2 — C-only sweep @ kv=1024, N=1

- Timestamp: 20260425_030542
- Config: `FUSEE_BATCH_K=4096 FUSEE_BATCH_T_US=100
  FUSEE_VALUE_SIZE=1024 FUSEE_BATCH_NUM_FLUSHERS=1`. Pool path
  active for kv ≥ 256.
- Cache-on peaks (Mops/s @T): A 13.92@T64, B 16.66@T64,
  C 16.85@T64, D 16.85@T64, F 15.48@T64.
- 80/80 OK, 0 FAIL.
