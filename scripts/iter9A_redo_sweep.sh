#!/usr/bin/env bash
# iter-9A redo Phase 4 — full scaling_ycsb sweep on the post-Phase-2
# architecture (3-ring + ForwardStaging + 6 named/pinned system threads,
# direct path; aggregator code in place but opt-in via FUSEE_USE_AGGREGATOR).
# Per docs/scaling_ycsb_spec.md (single-rep default).
set -u
